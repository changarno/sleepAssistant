...
public class PlayerActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ImageButton turnOnButton = (ImageButton) findViewById(R.id.imageButton8);
        ...
        turnOnButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // Intent is what you use to start another activity
                Intent myIntent = new Intent(PlayerActivity.this, PlayerOnActivity.class);
                startActivity(myIntent);
            }
        });
        ...
        backButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // Intent is what you use to start another activity
                Intent myIntent = new Intent(PlayerActivity.this, PlaylistActivity.class);
                startActivity(myIntent);
            }
        });
        ...
        faveButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // Intent is what you use to start another activity
                Intent myIntent = new Intent(PlayerActivity.this, FaveActivity.class);
                startActivity(myIntent);
            }
        });
        ...
        returnButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // Intent is what you use to start another activity
                Intent myIntent = new Intent(PlayerActivity.this, MenuActivity.class);
                startActivity(myIntent);
            }
        });
        ...
        leftButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // Intent is what you use to start another activity
                Intent myIntent = new Intent(PlayerActivity.this, Player2Activity.class);
                startActivity(myIntent);
            }
        });
